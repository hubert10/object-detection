...
class MaskRCNNDirected:
    ...
    def build(self, mode, config):
        ...
        if type(config.REGION_PROPOSALS) != type(None):
            ...
            rpn_rois = ProposalLayerDirected(
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.log_dir = (
            "D:\\Object Detection\\Kangaro - Transfer Learning\\logdir\\train"
        )
...
class MaskRCNNDirectedRPN:
    ...
    def build(self, mode, config):
        ...
        model = KM.Model(
            [input_image, input_image_meta, input_anchors], rpn_rois, name="mask_rcnn"
        )
