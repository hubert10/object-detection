...
COCO_MODEL_PATH = os.path.join(
    RCNN_ROOT, "kangaroo-transfer-learning/mask_rcnn_coco.h5"
)
...
train_dataset.load_dataset(
    dataset_dir="kangaroo-transfer-learning/kangaroo", is_train=True
)
...
validation_dataset.load_dataset(
    dataset_dir="kangaroo-transfer-learning/kangaroo", is_train=False
)
...
model = model.MaskRCNN(mode="training", model_dir="./", config=kangaroo_config)

model.load_weights(
    filepath="kangaroo-transfer-learning/mask_rcnn_coco.h5",
    by_name=True,
