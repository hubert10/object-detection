...
REGION_PROPOSALS = numpy.zeros(
    shape=(1, POST_NMS_ROIS_INFERENCE, 4), dtype=numpy.float32
)
...
REGION_PROPOSALS[0, 0, :] = [0.49552074, 0.0, 0.53763664, 0.09105143]
...
model = mrcnn_directed.model.MaskRCNNDirected(
...
mrcnn_directed.visualize.display_instances(
    image=image,
    boxes=r["rois"],
    masks=r["masks"],
